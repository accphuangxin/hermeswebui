...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Hermes Chat
            commands::createChatSession,
            commands::listChatSessions,
            commands::getChatSession,
            commands::updateChatSession,
            commands::deleteChatSession,
            commands::saveChatMessage,
            commands::saveChatMessagesBatch,
            ...
            commands::getHermesApiServerConfig,
            commands::setHermesApiServerConfig,
            commands::read_local_image,
            commands::read_local_html,
            ...
            commands::saveSummaryTempFile,
            commands::generateSessionSummary,
            commands::generateDailyReport,
            commands::getDailyReport,
            commands::getSummaryTemplate,
            commands::setSummaryTemplate,
            commands::approveChatRun,
            commands::approveRunChoice,
            ...
            commands::unlinkKanbanTasks,
            commands::resetKanbanTask,
            commands::unblockKanbanTask,
            commands::getTaskParents,
            commands::getTaskChildren,
            commands::getTaskRuns,
            commands::getTaskConversation,
            commands::getTaskThreadMessages,
            commands::getTaskEvents,
            commands::triggerKanbanBoard,
            commands::batchDeleteKanbanTasks,
            commands::batchResetKanbanTasks,
            commands::batchExecuteKanbanTasks,
            ...
            // knowledge base
            commands::knowledge_list_dir,
            commands::knowledge_read_file,
            commands::knowledge_write_file,
            commands::knowledge_create_file,
            commands::knowledge_create_dir,
            commands::knowledge_rename,
            commands::knowledge_delete,
            commands::knowledge_delete_recursive,
            commands::knowledge_get_base_path,
            commands::knowledge_import_files,
            commands::knowledge_import_folder,
            commands::knowledge_save_export_file,
            commands::knowledge_open_html_for_print,
...
fn show_migration_error_dialog(app: &tauri::AppHandle, error: &str) -> bool {
    ...
    let message = if is_chinese_locale() {
        ...
        format!(
            ...
            Consider rolling back to an older Hermes Web version.\n\n\
...
fn show_database_init_error_dialog(
    ...
    let message = if is_chinese_locale() {
        ...
        format!(
            ...
            2) If you see “database version is newer”, please upgrade Hermes Web\n\
